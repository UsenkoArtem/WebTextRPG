...
<body >
<div align="center">
    <img src="<c:url value="/resource/image/sprites/Images/Enemies/WoodLand/marauder2.png"/>"
...
<div style="position:  absolute; top:60% ; left:85%; color:#ff0000">
    <table style=" color: #ff0000;" id="enemy">
        ...
        <tr>
            ...
            <td style="padding: 20px" id="health"> ${Marauder.health}</td>

        </tr>
        <tr>
            <td style="padding: 20px"> Attack</td>
            <td style="padding: 20px"> ${Marauder.attack}</td>

        </tr>
        <tr>
            <td style="padding: 20px"> Defense</td>
            <td style="padding: 20px"> ${Marauder.defense}</td>
    ...
    <table style=" color: #4CAF50;" >
        ...
        <tr>
            <td style="padding: 20px">
                <input type="button" value="Head attack" onclick="headAttack('${Marauder.name}')"/>
            </td>

        </tr>
        <tr>
            <td style="padding: 20px">
                <input type="button" value="Body attack" onClick="bodyAttack('${Marauder.name}')"/>
            </td>

        </tr>
        <tr>
            <td style="padding: 20px">
                <input type="button" value="Legs attack" onclick="legsAttack('${Marauder.name}')"/>
            </td>
